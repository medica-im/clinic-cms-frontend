const espK = 'Équipe de soins primaires';
	...
	const mspV0=`Les maisons de santé pluriprofessionnelles sont des structures pluridisciplinaires où travaillent de manière coordonnée médecins et auxiliaires médicaux. L’idée est de créer un espace dédié à la coordination des soins au plus près de la population grâce au partage de compétences.`
