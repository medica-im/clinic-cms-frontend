...
<svelte:head>
	<title>
		Canicule - {capitalizeFirstLetter($LL.PREVENTIVE_HEALTHCARE())} - {capitalizeFirstLetter(
...
<section>
	<div class="section-container">
		...
		<div class="pl-5">
			<ul class="list-disc space-y-4 p-4">
				<li> <span class="inline-flex items-baseline space-x-1"><Fa icon={faMobile} size="sm"/> <a href="tel:08000666 66" class="anchor">0 800 06 66 66</a></span></li>
