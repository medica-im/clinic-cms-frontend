const aldK = 'affection de longue durée';
const aldV0 = 'En France, est désignée comme maladie de longue durée, ou affection de longue durée (ALD), l’une des trente maladies figurant sur la liste conçue par l’assurance maladie. Elle donne lieu à un remboursement intégral des soins, après établissement d’un protocole thérapeutique.'
